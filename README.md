...
NOTE: The point of this fork is that it builds via GH actions.  I wanted somewhere reputable to get tolk.dll
from.  Go over to the releases page and you can get tolk.dll and all supporting files for x64, built by GH actions
using the workflow in this repository.  They do not contain the JNI code.  I am not maintaining it beyond this point.
